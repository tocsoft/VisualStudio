...
{
    [ExportViewModel(ViewType=UIViewType.AddFileToSolution)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class AddFileToSolutionViewModel : BaseViewModel, IAddFileToSolutionViewModel
    {
        ...
        readonly ReactiveCommand<object> pickFileCommand = ReactiveCommand.Create();
        bool isLoading;
        bool noRepositoriesFound;
        readonly ObservableAsPropertyHelper<bool> canPickFile;
        string baseRepositoryPath;
        bool loadingFailed;

        [ImportingConstructor]
        AddFileToSolutionViewModel(
        ...
        public AddFileToSolutionViewModel(
            ...
            IUsageTracker usageTracker)
        {
            ...
            addCommand.Subscribe(_ => ShowChooseFileDialog());
        ...
        IObservable<Unit> ShowChooseFileDialog()
        {
            return Observable.Start(() =>
            {
        ...
        public IReactiveCommand<Unit> ChooseFileCommand
        {
            get
            {
