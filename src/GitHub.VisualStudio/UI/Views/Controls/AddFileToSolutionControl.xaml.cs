...
{
    public class GenericAddFileToSolutionControl : SimpleViewUserControl<IAddFileToSolutionViewModel, AddFileToSolutionControl>
    {}

    /// <summary>
    /// Interaction logic for CloneRepoControl.xaml
    /// </summary>
    [ExportView(ViewType=UIViewType.AddFileToSolution)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class AddFileToSolutionControl : GenericAddFileToSolutionControl
    {
        readonly Dictionary<string, RepositoryGroup> groups = new Dictionary<string, RepositoryGroup>();

        public AddFileToSolutionControl()
        {
            InitializeComponent();
        ...
        {
            readonly AddFileToSolutionControl owner;

            public RepositoryGroupDescription(AddFileToSolutionControl owner)
            {
                this.owner = owner;
            }
